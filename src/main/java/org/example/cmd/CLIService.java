...
public class CLIService {
    ...
    public static void handleCmdArgs(String[] args) {
        ...
        for (String arg : args) {
            if (arg.startsWith("--help")) {
                ...
                return;
            } else if (arg.startsWith(CommandArgument.GUI_INTERACTION_MODE.getValue())) {
                cliMode = "CLI";
    ...
    private static String generateHelpMessage() {
        ...
        sb.append("  --GUI                      Run the application in GUI (Graphical User Interface) mode.\n");
